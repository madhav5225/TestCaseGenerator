									...
									<div id="array_random_array" class="panel-collapse collapse"
										...
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-6">
													<label>N Test Cases</label> <input type="text"
														class="form-control" id="TestCasesForArray"
														placeholder="n_test_cases" data-type="param"
														data-param-name="n_test_cases">
												</div>
												<div class="col-xs-6">
													<label>Arr Size</label> <input type="text"
														class="form-control" id="ArraySize" placeholder="arr_size"
												...
												<div class="col-xs-6">
													...
													<label>Include N Flag</label> <select data-type="param"
														data-param-name="include_n_flag" id="SizeFlagForArray"
														class="form-control">
														<option value="0">False</option>
														<option value="1">True</option>
													</select>
											...
											<div class="row">
												<div class="col-xs-6">
													<label>T Test Cases</label> <input id="TestCasesForString"
														...
														placeholder="T_test_cases" data-type="param"
														data-param-name="n_test_cases">
												</div>

												<div class="col-xs-6">
													<label>String Length</label> <input id="StringSize"
														type="text" class="form-control" placeholder="str_size"
														data-type="param" data-param-name="str_size">
												</div>

												<div class="col-xs-6">
													<label>No. of Strings per Test Case</label> <input
														id="NumberOfStringsPerT" type="text" class="form-control"
												...
												<div class="col-xs-6">
													...
													<label>Extra Chars</label> <input id="StringExtraChars"
														class="form-control" placeholder="extras"
												...
												<div class="col-xs-6">
													<label>Include N Size Flag</label> <select
														...
														data-param-name="include_n_size_flag" class="form-control">
														<option value="0">False</option>
														<option value="1">True</option>
													</select>
												</div>
